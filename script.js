...
// Criando ordem aleatórias de cores.
let shuffleOrder = () => {
...
// Faz a checagem se os botões são os mesmos da ordem gerada no jogo.
let checkOrder = () => {
    ...
    if (clickedOrder.length == order.length) {
        ...
        nextLevel();
        const btnScore = document.getElementById('Print');
        btnScore.innerHTML = `Score: ${score}`;
    }
}
